...
- [ ] 7a — fresh-context prose-rewriter memos per section (6 agents, sonnet tier; register samples: Srinivasan 2018 + Jenkins 2020, logged); reconcile into v1.5
- [ ] 7b — self-edit + ai-tells + prose_lint.py with FLAG dispositions
- [ ] 7c — cold-reader friction report; iterate 7a→7c until clean (0–5)
