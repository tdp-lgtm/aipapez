# Checklist — liability-defensive-harm

## Stage 0 — Setup
- [x] Intake recorded in Brief/ and Process Log (topic/tradition; slots; autonomy; readings; runway) — `Brief/Intake.md` + Process Log Session 1: topic = a new account of liability to defensive harm (custodian's choice); slot 3/3 (essay 2 in another session); default checkpoints; 19 supplied papers + own search; quality-first runway; OpenReview not yet registered (reminder issued)
- [x] Folder tree scaffolded; Checklist + Progress Log + Process Log created — new_essay.py run 2026-09-24; standard tree verified; upload preserved and split into 19 files in `Background Readings/Converted text/` with a bibliographic key (`README.md`)
- [x] Competition Brief + Rules — Human Involvement re-read this run — read in full 2026-09-24 before intake
